        ...
        <div className="orbit-area">
          <div className="orbit-float">
            <div className="orbit-scene">
              <CenterMonogram />
              <OrbitRing items={RING1} radius={72} duration={20} reverse={false} itemSize={42} iconSize={20} layerZIndex={50} />
              <OrbitRing items={RING2} radius={120} duration={30} reverse itemSize={36} iconSize={17} layerZIndex={40} />
              <OrbitRing items={RING3} radius={164} duration={38} reverse={false} itemSize={34} iconSize={16} layerZIndex={30} />
              <OrbitRing items={RING4} radius={208} duration={50} reverse itemSize={30} iconSize={15} layerZIndex={20} />
            </div>
          </div>
        </div>
      </div>
